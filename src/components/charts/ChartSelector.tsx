...
import { type GraphSelectorPropsType, CombinedRaceCircuitPropertyEnum } from '../../libs/interfaces'
...
export default function ChartSelector({ raceData }: GraphSelectorPropsType): React.JSX.Element {
