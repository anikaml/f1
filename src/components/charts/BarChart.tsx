...
import { type GeneralGraphPropsType } from '../../libs/interfaces'
...
export default function BarChart({ data, yAxisText }: BarChartPropsType): React.JSX.Element {
  ...
  const ref = useD3(
    async function paint(svg) {
      ...
      if (max === undefined) { // if d3.max returned undefined (in case of an empty array), set max to 0
        max = 0
      }
      ...
      const xAxis = (g: d3.Selection<SVGGElement, any, null, undefined>): d3.Selection<SVGGElement, any, null, undefined> => g
